...
export default function Button({
  ...
  const colorVariants = {
    ...
    "command-t1":
      "uppercase bg-key-command-background-t1 shadow-key-command-shadow-t1 hover:shadow-key-command-shadow-t1 focus-visible:shadow-key-command-shadow-t1 active:shadow-key-command-shadow-t1 text-text-default-t1",
    "equal-t1":
      "bg-key-equal-background-t1 shadow-key-equal-shadow-t1 hover:shadow-key-equal-shadow-t1 focus-visible:shadow-key-equal-shadow-t1 active:shadow-key-equal-shadow-t1 text-text-default-t1",
  };
